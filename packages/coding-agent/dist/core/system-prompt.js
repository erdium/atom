...
export function buildSystemPrompt(options) {
    ...
    let prompt = `You are an expert coding assistant operating inside atom, a coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.
