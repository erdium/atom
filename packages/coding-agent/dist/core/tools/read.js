...
function formatReadCall(args, theme, cwd, label) {
...
function formatReadResult(args, result, options, theme, showImages, _cwd, isError, label) {
...
export function createReadToolDefinition(cwd, options) {
    ...
    return {
        ...
        renderResult(result, options, theme, context) {
            const text = context.lastComponent ?? new Text("", 0, 0);
            text.setText(formatReadResult(context.args, result, options, theme, context.showImages, context.cwd, context.isError, "Read"));
            return text;
        },
    };
}
