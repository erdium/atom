...
export class InteractiveMode {
    ...
    constructor(runtimeHost, options = {}) {
        ...
        this.defaultWorkingMessage = "Running...";
    ...
    createWorkingLoader() {
        return new Loader(this.ui, (spinner) => theme.fg("selectionColor", spinner), (text) => theme.fg("muted", text), this.getWorkingLoaderMessage(), this.workingIndicatorOptions);
    }
    stopWorkingLoader() {
        if (this.loadingAnimation) {
            this.loadingAnimation.stop();
