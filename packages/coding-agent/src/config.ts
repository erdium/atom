...
export const APP_NAME: string = piConfigName || "atom";
export const APP_TITLE: string = piConfigName ? APP_NAME : "Atom";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".atom";
